...
<div class="space-y-3">
	<div
		class="grid gap-3 rounded-2xl border bg-card p-3 sm:p-4 lg:grid-cols-[minmax(20rem,1fr)_auto] lg:items-end"
	>
	...
	<div
		class={[
			'overflow-hidden rounded-2xl border bg-card transition-opacity [&_[data-slot=table-container]]:overflow-x-hidden',
